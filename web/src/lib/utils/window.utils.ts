import type { AppType, AppWindowActions } from '$lib/types/app.types'
import { defaultAppWindowActions, defaultDimensions } from '$lib/data/window.defaults'
import type { WindowDimensions } from '$lib/types/window.types'
